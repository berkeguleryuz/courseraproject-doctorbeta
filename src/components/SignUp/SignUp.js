  ...
  return (
    <div className="container" style={{ marginTop: "5%" }}>
      <div className="signup-grid">
        ...
        <div className="bg-gray-200 w-[600px] rounded-md">
          <form method="POST" onSubmit={register}>
            <div className="form-group">
                <h1 className="text-black font-bold mt-3">Role</h1>
                <input
            ...
            <div className="btn-group">
              <button
                type="submit"
                className="bg-blue-600 mb-4 waves-effect waves-light">
                Submit
              </button>
              <button
                type="reset"
                className="bg-red-800 mb-2 waves-effect waves-light">
                Reset
              </button>
            </div>
          </form>
